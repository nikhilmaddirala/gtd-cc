...
**File**: `issue-creation-workflow.md`
...
**File**: `human-approval-workflow.md`
...
1. First run `repo-setup-workflow.md` (Stage 0) in new repositories
2. Then create issues using `issue-creation-workflow.md` (Stage 1)
...
1. For planning feedback: Use `plan-workflow.md` to revise (Stage 2)
2. For review feedback: Update code and follow `commit-workflow.md` (General)
3. For approval feedback: Use `human-approval-workflow.md` (Stage 6)
...
All workflow details are contained in individual `.md` files in the `workflows/` directory. Each file follows the same structure:
- YAML frontmatter (description and allowed tools)
- Context/prerequisites
- Your Task (goal and role)
