---
name: doc-compress
description: Compress verbose documentation while preserving critical information
---
...
- Load docs-management (or its compress.md sub-skill if targeting a specific procedure); you MUST do this first.
